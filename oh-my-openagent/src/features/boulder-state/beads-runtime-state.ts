...
export function applyBeadsRuntimeToBoulderState(
  ...
  return {
    ...
    ...(beadsRuntime.sourceCommand !== undefined ? { bead_source_command: beadsRuntime.sourceCommand } : {}),
    ...(beadWorktreePath !== undefined ? { bead_worktree_path: beadWorktreePath } : {}),
    ...(beadsRuntime.lastReconciledAt !== undefined ? { bead_last_reconciled_at: beadsRuntime.lastReconciledAt } : {}),
  }
}
...
export function getBoulderBeadsRuntimeMetadata(
  ...
  return {
    beadID,
    ...(state.bead_source_command !== undefined ? { sourceCommand: state.bead_source_command } : {}),
    ...(worktreePath !== undefined ? { worktreePath } : {}),
    ...(state.bead_last_reconciled_at !== undefined ? { lastReconciledAt: state.bead_last_reconciled_at } : {}),
  }
}
