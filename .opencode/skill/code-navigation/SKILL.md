...
When tilth is available, it provides superior navigation. Main-agent workflows should prefer Tilth MCP; CLI Tilth remains the companion path for subagents and shell-only flows.
